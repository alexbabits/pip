...
import {Pip, PoseidonT3, IERC20} from "../src/Pip.sol";
...
contract PipTest is Test {
    ...
    function testDepositETH() public {
        ...
        emit Pip.Deposit(c0, 0, 0, 0x1fbc1a3e387b8f5005c80ac46239dd4309fee036b476ceb05d53743a1e549225); 
        ...
        vm.expectEmit(true, true, true, true);
        emit Pip.Deposit(c1, 1, 0, 0x2525a57bd217c7c91cc404dfd7a682c56f8a155084604057c338777598369170);
    ...
    function testWithdrawETH() public {
        ...
        emit Pip.Withdrawal(s.recipient, s.nullifierHash);
        pip.withdraw(p, s); 
