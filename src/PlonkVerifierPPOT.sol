...
// NOTE: Generated from `withdraw.circom`
// NOTE: Used Universal Perpetual Powers of Tau (PPoT) file for phase 1 setup: `ppot_0080_14.ptau` from: 
// NOTE: https://github.com/privacy-scaling-explorations/perpetualpowersoftau/tree/master?tab=readme-ov-file#prepared-and-truncated-files
// NOTE: This verifier has no backdoor because PPoT participants discarded their toxic waste. (PLONK has no phase 2 MPC setup requirement).
contract PlonkVerifierPPOT {
    // Omega
    ...
    uint256 constant Qmx  = 20913878583479091350157785337546862960681390423109129850000464828525619323089;
    uint256 constant Qmy  = 817284854868994300125722802439924012948401202841204256969291089842275975456;
    uint256 constant Qlx  = 10299468886272822729635463293500352135366282857593172448669343515859043841076;
    uint256 constant Qly  = 1254456190375343155796521111761735014066870410286112497359829194149320467381;
    uint256 constant Qrx  = 19369479092571831516125004389735452667654781966055432753573827164229332943041;
    uint256 constant Qry  = 21839933461993417722652548237173862011101305153061138732447495224689582284035;
    uint256 constant Qox  = 5305132596838342689678437322560113030640234206103644429442258183284521378945;
    uint256 constant Qoy  = 1354326918551403783470126204836626048756358571213015394401774612999081507586;
    uint256 constant Qcx  = 15719003749192421837995987179450112916245854350301956935000979579256254027286;
    uint256 constant Qcy  = 10991019410143550099518256696033715928639471416401840965290277265656519435071;
    uint256 constant S1x  = 2181919973059430433358873888045325270215712372186730837405571110801791078997;
    uint256 constant S1y  = 21749590679254011955306595355547239396245274402594173920466654613720822797528;
    uint256 constant S2x  = 20704827125840322234596172647315149327930067571475751211003605979245834938949;
    uint256 constant S2y  = 16318122600888699737823242831981273640011219667671373995779163661517477108053;
    uint256 constant S3x  = 14958700883463063115932259831897792869305037481769905983190181467124618365353;
    uint256 constant S3y  = 18124154112327229546874543809526039094696231707255522475917067350566161205110;
    ...
    // NOTE: commented out `_proof` to stop compiler warning. `_proof` values are accessed directly via the assembly.
