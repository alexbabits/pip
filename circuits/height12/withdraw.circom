...
template Withdraw(height) {
    ...
    // Add intermediary signal with unused recipient public signal
    // Probably not required but only takes 2 constraints
...
component main {public [recipient, nullifierHash, root]} = Withdraw(12);